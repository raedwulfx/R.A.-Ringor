...
const BackgroundEffect = () => (
  <div className="absolute inset-0 overflow-hidden">
    <div className="absolute inset-0 bg-gradient-to-r from-[#e11d48]/20 to-[#f87171]/20 blur-3xl animate-pulse" />
    <div className="absolute inset-0 bg-gradient-to-tr from-[#e11d48]/10 via-transparent to-[#f87171]/10 blur-2xl animate-float" />
  </div>
);

const IconButton = ({ Icon }) => (
  <div className="relative group hover:scale-110 transition-transform duration-300">
   <div className="absolute -inset-2 bg-gradient-to-r from-[#e11d48] to-[#f87171] rounded-full blur opacity-30 group-hover:opacity-75 transition duration-300" />
        ...
        >
          ...
          <div className="relative min-h-screen flex items-center justify-center px-4">
            <div className="w-full max-w-4xl mx-auto">
                ...
                <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold space-y-2 sm:space-y-4">
                 ...
                 <div>
                  <span
                    data-aos="fade-up"
                    data-aos-delay="800"
                    className="inline-block px-2 bg-gradient-to-r from-[#e11d48] to-[#f87171] bg-clip-text text-transparent"
                  >
                    Portfolio
                  </span>{' '}
                  <span
              ...
              >
                <a
                  href="https://www.facebook.com/rae.shlt"
                  className="inline-flex items-center gap-2 px-4 py-2 sm:px-6 sm:py-3 rounded-full relative group hover:scale-105 transition-transform duration-300"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  
                <div className="absolute inset-0 bg-gradient-to-r from-[#e11d48]/20 to-[#f87171]/20 rounded-full blur-md group-hover:blur-lg transition-all duration-300" />
