...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/ralph-axle-ringor-a0961517b/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@typ.xiee",
    icon: Instagram,
    url: "https://www.instagram.com/typ.xiee/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@wrckxtxrlph",
    icon: Youtube,
    url: "https://www.youtube.com/@wrckxtxrlph",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@raedwulfx",
    icon: Github,
    url: "https://github.com/raedwulfx",
    color: "#ffffff",
